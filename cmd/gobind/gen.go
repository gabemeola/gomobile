...
import (
	...
	"github.com/gabemeola/gomobile/bind"
	"github.com/gabemeola/gomobile/internal/importers"
	"github.com/gabemeola/gomobile/internal/importers/java"
	"github.com/gabemeola/gomobile/internal/importers/objc"
...
func genPkg(lang string, p *types.Package, astFiles []*ast.File, allPkg []*types.Package, classes []*java.Class, otypes []*objc.Named) {
	...
	case "java":
		...
		if p == nil {
			dir, err := packageDir("github.com/gabemeola/gomobile/bind")
			if err != nil {
				errorf(`"github.com/gabemeola/gomobile/bind" is not found; run go get github.com/gabemeola/gomobile/bind: %v`, err)
				return
			}
			repo := filepath.Clean(filepath.Join(dir, "..")) // github.com/gabemeola/gomobile directory.
			...
			javaDir, err := packageDir("github.com/gabemeola/gomobile/bind/java")
			if err != nil {
				errorf("unable to import bind/java: %v", err)
				return
			}
	...
	case "objc":
		...
		if p == nil {
			// Copy support files
			dir, err := packageDir("github.com/gabemeola/gomobile/bind/objc")
			if err != nil {
