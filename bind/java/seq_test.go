...
import (
	...
	"github.com/gabemeola/gomobile/internal/importers/java"
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/gabemeola/gomobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/gabemeola/gomobile/bind/testdata/benchmark"}, "", "SeqBench")
}
